...
void EnQueueMH(Queue &QUMH,MatHang mh)
{
    Node *p=createNodeMH(mh);
    if(QUMH.Tail==NULL)
    {
        QUMH.Head=QUMH.Tail=p;
    }
    else{
        p->next=QUMH.Tail;
        QUMH.Tail->prev=p;
...
void EnQueueHD(Queue &QUHD,hoadon hd)
{
    Node *p=createNodeHD(hd);
    if(QUHD.Tail==NULL)
    {
        QUHD.Head=QUHD.Tail=p;
    }
    else{
        p->next=QUHD.Tail;
        QUHD.Tail->prev=p;
...
void EnQueueKH(Queue &QUKH,khachhang kh)
{
    Node *p=createNodeKH(kh);
    if(QUKH.Tail==NULL)
    {
        QUKH.Head=QUKH.Tail=p;
    }
    else{
        p->next=QUKH.Tail;
        QUKH.Tail->prev=p;
...
void EnQueueNV(Queue &QUNV,nhanvien nv)
{
    Node *p=createNodeNV(nv);
    if(QUNV.Tail==NULL)
    {
        QUNV.Head=QUNV.Tail=p;
    }
    else{
        p->next=QUNV.Tail;
        QUNV.Tail->prev=p;
...
//EnQueue
MatHang DeQueueMH(Queue &QUMH)
{
    if(QUMH.Tail!=NULL)
    {
        if(QUMH.Head==QUMH.Tail)
        {
            MatHang k=QUMH.Head->MH;
            QUMH.Head=QUMH.Tail=NULL;
            return k;
        }
        else{
            Node *p=QUMH.Head;
        MatHang a=p->MH;
        QUMH.Head=QUMH.Head->prev;
        QUMH.Head->next=NULL;
        p->prev=NULL;
        delete(p);
        p=NULL;
...
khachhang DeQueueKH(Queue &QUKH)
{
    if(QUKH.Tail!=NULL)
    {
        if(QUKH.Head==QUKH.Tail)
        {
            khachhang k=QUKH.Head->KH;
            QUKH.Head=QUKH.Tail=NULL;
            return k;
        }
        else{
            Node *p=QUKH.Head;
        khachhang a=p->KH;
        QUKH.Head=QUKH.Head->prev;
        QUKH.Head->next=NULL;
        p->prev=NULL;
        delete(p);
        p=NULL;
...
hoadon DeQueueHD(Queue &QUHD)
{
    if(QUHD.Tail!=NULL)
    {
        if(QUHD.Head==QUHD.Tail)
        {
            hoadon k=QUHD.Head->HD;
            QUHD.Head=QUHD.Tail=NULL;
            return k;
        }
        else{
            Node *p=QUHD.Head;
        hoadon a=p->HD;
        QUHD.Head=QUHD.Head->prev;
        QUHD.Head->next=NULL;
        p->prev=NULL;
        delete(p);
        p=NULL;
...
nhanvien DeQueueNV(Queue &QUNV)
{
    if(QUNV.Tail!=NULL)
    {
        if(QUNV.Head==QUNV.Tail)
        {
            nhanvien k=QUNV.Head->NV;
            QUNV.Head=QUNV.Tail=NULL;
            return k;
        }
        else{
            Node *p=QUNV.Head;
        nhanvien a=p->NV;
        QUNV.Head=QUNV.Head->prev;
        QUNV.Head->next=NULL;
        p->prev=NULL;
        delete(p);
        p=NULL;
...
void deleteMH(Queue &QUMH)
{
    ...
    Queue k;
    Init(k);
    while(QUMH.Head!=NULL)
    {
        MatHang t=DeQueueMH(QUMH);
        if(strcmp(t.mahang,a)==0)
        {
            check=true;
            cout<<"Da xoa mat hang co ma "<<t.mahang<<endl;
            continue;
        }
        else{
            EnQueueMH(k,t);
    ...
    if(check==false)
    {
        cout<<"Khong co mat hang co ma "<<a<<endl;
    }
    while(k.Head!=NULL)
    {
        MatHang l=DeQueueMH(k);
        EnQueueMH(QUMH,l);
    }
}

void deleteHD(Queue &QUHD)
{
    char a[11];
    cin.ignore();
    cout<<"Nhap ma hoa don can xoa:";
    ...
    Queue k;
    Init(k);
    while(QUHD.Head!=NULL)
    {
        hoadon t=DeQueueHD(QUHD);
        if(strcmp(t.mahoadon,a)==0)
        {
            check=true;
            cout<<"Da xoa hoa don co ma "<<t.mahoadon<<endl;
            continue;
        }
        else{
            EnQueueHD(k,t);
    ...
    if(check==false)
    {
        cout<<"\nKhong hoa don co ma "<<a<<endl;
    }
    while(k.Head!=NULL)
    {
        hoadon l=DeQueueHD(k);
        EnQueueHD(QUHD,l);
    }
}

void deleteKH(Queue &QUKH)
{
    char a[11];
    cin.ignore();
    ...
    Queue k;
    Init(k);
    while(QUKH.Head!=NULL)
    {
       khachhang t=DeQueueKH(QUKH);
       if(strcmp(t.maKH,a)==0)
       {
           check=true;
           cout<<"Da xoa khach hang co ma "<<t.maKH<<endl;
           continue;
       }
       else{
          EnQueueKH(k,t);
    ...
    if(check==false)
    {
        cout<<"\nKhong co khach hang co ma "<<a<<endl;
    }
    while(k.Head!=NULL)
    {
       khachhang l=DeQueueKH(k);
       EnQueueKH(QUKH,l);
    }
}


void deleteNV(Queue &QUNV)
{
    char a[11];
    cin.ignore();
    ...
    Init(k);
     bool check=false;
    while(QUNV.Head!=NULL)
    {
        nhanvien t=DeQueueNV(QUNV);
        if(strcmp(t.maNV,a)==0)
        {
            check=true;
            cout<<"Da xoa nhan vien co ma "<<t.maNV<<endl;
            continue;
        }
        else{
            EnQueueNV(k,t);
    ...
    while(k.Head!=NULL)
    {
        nhanvien l=DeQueueNV(k);
        EnQueueNV(QUNV,l);
    }
}

//SAP XEP
void SortMHofTenMH(Queue &QUMH)
{
    for(Node *p=QUMH.Tail;p!=NULL;p=p->next)
    {
...
void SortKHofTen(Queue &QUKH)
{
    for(Node *p=QUKH.Tail;p!=NULL;p=p->next)
    {
        for(Node *q=p->next;q!=NULL;q=q->next)
        {
...
void SortHDofNgayLap(Queue &QUHD)
{
    int dem=0;
    for(Node *p=QUHD.Tail;p!=NULL;p=p->next)
    {
        if(p->next==NULL)
        {
            p=QUHD.Tail;
...
void SortNVofTen(Queue &QUNV)
{
    for(Node *p=QUNV.Tail;p!=NULL;p=p->next)
    {
        for(Node *q=p;q!=NULL;q=q->next)
        {
...
void SearchHDofMaKH(Queue QUHD)
{
    char a[20];
...
void SearchHDofMaNV(Queue QUHD)
{
    char a[20];
    cout<<"Nhap ma nhan vien:";
    cin.getline(a,20);
...
void SearchHDofMaMH(Queue QUHD)
{
    char a[20];
    cout<<"Nhap ma mat hang:";
    cin.getline(a,20);
...
void SearchHDofMaHD(Queue QUHD)
{
    char a[20];
    cout<<"Nhap ma hoa don:";
    cin.getline(a,20);
...
void DoanhThuTheoNgay(Queue QUHD)
{
    char a[20];
...
void DoanhThuTheoThang(Queue QUHD)
{
    char a[20];
    cout<<"Nhap thang nam:";
    cin.getline(a,20);
...
int  CountMaxHDofMaMH(Queue QUHD)
{   int maxx=0;
    for(Node *p=QUHD.Tail;p!=NULL;p=p->next)
    {   int dem=0;
        for(Node *q=p;q!=NULL;q=q->next)
...
void SpMuaNhieu(Queue QUHD)
{
    ...
    {   int dem=0;
        ...
        if(dem==CountMaxHDofMaMH(QUHD) && strcmp(a,p->HD.masanpham)!=0)
        {
...
int demSLMax(Queue QUHD,int year)
{   int slmax=0;
    for(int i=1;i<13;i++)
    {
        int demsl=0;
...
void ThangMuaNhieu(Queue QUHD)
{
   ...
   for(int i=1;i<13;i++)
   {
       ...
       if(demsl==demSLMax(QUHD,year) && check==false)
       {
...
void MHkoBanDuoc(Queue QUHD)
{
    ...
    {
        bool check=true;
        for(Node *q=QUHD.Tail;q!=NULL;q=q->next)
        {
                    ...
                    else if(n2==8)
                    {
                        ...
                        else
                        {
                            while(true)
                            {
                                ...
                                if(tl==1)
                                {
                                    DoanhThuTheoNgay(QUHD);
                                    cout<<endl;
                                }
                                else if(tl==2)
                                {
                                    DoanhThuTheoThang(QUHD);
                                    cout<<endl;
                                }
                                else if(tl==0)
                                {
